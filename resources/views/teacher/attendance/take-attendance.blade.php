...
@section('content')
    @php
        $studentList = ($students ?? collect())->where('status', 2)->values();
    @endphp
                ...
                @if($studentList->isEmpty())
                    <div class="flex flex-col items-center justify-center py-16 px-6">
                        ...
                        <div class="flex justify-center">
                            <a href="{{ route('teacher.attendance.index') }}" class="btn-primary inline-flex items-center justify-center gap-2 px-6 py-2.5 rounded-xl text-sm font-medium">
