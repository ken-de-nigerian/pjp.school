...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta property="og:title" content="{{ ($title ?? 'Results') . ' | ' . (site_settings()?->name ?? config('app.name')) }}">
        ...
        <meta name="twitter:title" content="{{ ($title ?? 'Results') . ' | ' . (site_settings()?->name ?? config('app.name')) }}">
