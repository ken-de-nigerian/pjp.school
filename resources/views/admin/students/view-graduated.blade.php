...
@extends('layouts.app', ['title' => 'Graduated student'])
...
@section('content')
    <main class="flex-1 flex flex-col min-h-0 w-full overflow-y-auto overflow-x-hidden overscroll-y-none lg:pb-8 scrollbar-hide" style="background: var(--surface);">
        <div
            ...
            <x-admin.hero-page
                aria-label="Graduates by year"
                pill="Admin"
                :title="'Graduated in ' . e($year)"
                description="View students who graduated in this year. Search by name or reg. number."
            >
                <x-slot name="above">
                    <a href="{{ route('admin.graduated') }}" class="admin-page-hero__back mb-2 sm:mb-0">
