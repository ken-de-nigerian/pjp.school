...
@section('content')
<div class="mb-6">
    <h1 class="text-2xl font-semibold">Uploaded results</h1>
    <p class="text-gray-600 text-sm mt-1">View uploaded (unpublished) results by class, term, session and subject.</p>
</div>
<div class="bg-white rounded-lg shadow p-6">
    <form action="{{ route('teacher.uploaded.index') }}" method="GET" class="flex flex-wrap gap-4 items-end">
        ...
        <div><label class="block text-sm text-gray-700">Subject</label><input type="text" name="subjects" class="rounded border border-gray-300 px-2 py-1" placeholder="Subject" value="{{ request('subjects') }}"></div>
