            ...
            <div class="auth-form-body">
                <div class="form-group">
                    ...
                    <div class="auth-glass-field @error('email') auth-glass-field--error @enderror">
                        ...
                        <input type="email" name="email" id="email" value="{{ old('email') }}" class="auth-glass-input @error('email') form-input--error @enderror" placeholder="you@school.edu" autocomplete="email" required>
                    </div>
                    @error('email')
