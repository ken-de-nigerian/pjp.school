...
<div class="mb-6 flex justify-between items-center">
    <h1 class="text-2xl font-semibold">Edit Academic Session</h1>
...
<div class="bg-white rounded-lg shadow p-6 max-w-md">
    <form action="{{ route('admin.sessions.update', $session->id) }}" method="POST">
        ...
        <div>
            ...
            <input type="text" name="year" id="year" value="{{ old('year', $session->year) }}" placeholder="e.g. 2024/2025" required class="mt-1 block w-full rounded border border-gray-300 px-3 py-2">
