@extends('layouts.app', ['title' => 'Register teacher'])
                        ...
                        <div class="rounded-xl p-4 sm:p-5 border" style="background: var(--surface-container-low); border-color: var(--card-border);">
                            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                <div class="min-w-0">
                                    ...
                                    <p class="text-sm mb-0" style="color: var(--on-surface-variant);">Grants access to add and edit attendance and behavioural records for assigned classes (not result editing—enable that separately after registration).</p>
                                </div>
