@extends('layouts.app', ['title' => 'Left school'])
...
@section('content')
    <main class="flex-1 flex flex-col min-h-0 w-full overflow-y-auto overflow-x-hidden overscroll-y-none lg:pb-8 scrollbar-hide" style="background: var(--surface);">
        <div class="page-content flex-1 flex flex-col w-full max-w-7xl mx-auto min-w-0 px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10">
            <x-admin.hero-page
                aria-label="Students who left school"
                pill="Admin"
                title="Students who left school"
                description="View students by year they left. Select a year to see records."
            >
                <x-slot name="above">
