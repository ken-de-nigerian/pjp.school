                ...
                <form action="{{ route('result.check') }}" method="GET" class="auth-form">
                    <div class="auth-form-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="reg_number" name="reg_number" value="{{ old('reg_number', request('reg_number')) }}" class="form-input" autocomplete="off" placeholder="Enter your student ID">
                        </div>

                        @if($scratchRequired)
                            <div class="form-group">
                                <label for="scratch_card" class="form-label">Scratch card number</label>
                                <input type="text" id="scratch_card" name="scratch_card" value="{{ old('scratch_card', request('scratch_card')) }}" class="form-input" autocomplete="off" placeholder="Enter scratch card number">
                            </div>
                        @endif
                    </div>
