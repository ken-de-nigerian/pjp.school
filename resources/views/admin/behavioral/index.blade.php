@extends('layouts.app', ['title' => 'Behavioural analysis'])
                    ...
                    @empty
                        <div class="col-span-full flex-1 flex flex-col items-center justify-center py-12 sm:py-16">
                            <div class="rounded-3xl p-8 sm:p-12 text-center w-full max-w-lg" style="background: var(--surface-container-lowest); border: 1px solid var(--outline-variant); box-shadow: var(--elevation-1);">
                                ...
                                <p class="text-sm font-normal mb-8" style="color: var(--on-surface-variant);">Add classes and assign students to take behavioural analysis for the current term.</p>
